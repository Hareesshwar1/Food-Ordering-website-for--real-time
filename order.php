    ...
    <div class="container">
        ...
        <form action="" method="POST" class="order">
            ...
            <fieldset>
                ...
                <input type="tel" name="contact" placeholder="contact" class="input-responsive" required>

                <div class="order-label">Email</div>
                <input type="email" name="email" placeholder="eg:....@gmail.com" class="input-responsive" required>
